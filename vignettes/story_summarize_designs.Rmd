---
title: "What the Vignette Does (Title Case)"
output:
...
- the average hazard ratio (AHR) method extended from @MukhopadhyayAHR using `gsDesign2::gs_design_ahr()`;
- the weighted logrank (WLR) method of @YungLiu using `gsDesign2::gs_design_wlr()`;
