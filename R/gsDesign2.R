...
#' gsDesign2: A package for group sequential design under non-proportional hazards (NPH)
#'
#' The gsDesign2 package will eventually be incorporated into the gsDesign2 package.
...
#' The gsDesign2 package has 4 types of functions
